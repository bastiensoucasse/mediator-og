...
<head>
    ...
    <script>
        <?php require_once "include/scripts/service-worker.min.js"; ?>
    </script>
    <script>
        <?php require_once "include/scripts/lazysizes.min.js"; ?>
    </script>
    <style>
        <?php require_once "include/styles/hylery.css"; ?>
    </style>
    <style>
        <?php require_once "include/styles/mediator.css"; ?>
    </style>
    <title><?= TITLE ?></title>
</head>