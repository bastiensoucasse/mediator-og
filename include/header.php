        ...
        <?php if ($db->is_connected()) { ?>
            <div id="account-overview">
                <div id="account-banner">
                    ...
                    <div id="account-avatar"><img class="lazyload" alt data-sizes="auto" data-src="<?= "/images/avatars/x96/$user->avatar.webp" ?>" /></div>
                </div>
                <div id="account">
                    <div id="account-links">
                        <a class="account-link" href="/order" aria-label="Commander">
                            <span class="account-link-icon"><?php require "include/icons/tag.svg"; ?></span>
                            <span class="account-link-label">Commander</span>
                        </a>
