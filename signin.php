...
<body>
    <main id="main" class="fullscreen">
        <form id="signin" class="section limited form" action="signin?src=<?= $src ?>" method="post">
            ...
            <p class="paragraph">Vous avez déjà un compte ? <a class="link" href="<?= "/login?src=" . urlencode($src) ?>" aria-label="Se connecter">Se connecter</a></p>
        </form>
    </main>
</body>
